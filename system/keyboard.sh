...
# the '\033' escape sequence, in addition to separating the options.
...
defaults write com.apple.speech.recognition.AppleSpeechRecognition.prefs \
  DictationIMIntroMessagePresented -bool true

# Use enhanced dictation
# Allows offline use and continuous dictation with live feedback
if [ -d '/System/Library/Speech/Recognizers/SpeechRecognitionCoreLanguages/en_GB.SpeechRecognition' ]; then
  defaults write com.apple.speech.recognition.AppleSpeechRecognition.prefs \
