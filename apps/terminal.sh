...
# Enable in Accessibility Database
...
# Use a IR_Black theme by default in Terminal.app
if ! defaults read com.apple.terminal "Window Settings" | grep -q "IR_Black"; then
  osascript <<EOD
